...
cd "...\SimulvsRE\"
capture log close
log using Si1000_TrueFE_N1000T4_beta_1.log, replace
clear ado
clear all
set matsize 10000
...
/* Simulate from a FE dynamic model and compare the following estimators of the AME:
...
set obs 1
gen kk=.
save Si1000_TrueFE_N1000T4_beta_1.dta, replace
clear
...
display "simul", `i'
  ...
  scalar beta=1
	...
	display "It is a mixture of two normals"
	gen eta1=rnormal(-1,3)
	gen eta2=rnormal(0.5,3)
...
/*Estimator without Unobserved Heterogeneity*/
    ...
    append using Si1000_TrueFE_N1000T4_beta_1.dta
    capture drop kk
    save Si1000_TrueFE_N1000T4_beta_1.dta, replace
    clear 
}
